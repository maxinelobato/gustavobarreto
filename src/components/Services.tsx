                  ...
                  <AccordionPanel pb={4}>
                    <Box>
                      <Text pt="1" fontSize="sm">
                        <Icon as={FcCheckmark} color={'brandorange.500'} /> A ideia é
                        lícita?
                      </Text>
                      ...
                      <Text pt="2" fontSize="sm">
                        ...
                        obrigação de ter alguma certificação ou registro em algum órgão?
                      </Text>
                      <Text pt="2" fontSize="sm">
                ...
                <AccordionItem>
                  ...
                  <AccordionPanel pb={4}>
                    ...
                    <Box>
                      ...
                      <Text pt="2" fontSize="sm">
                        <Icon as={FcCheckmark} color={'brandorange.500'} /> Elaboração
